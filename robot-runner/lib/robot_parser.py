...
class RobotReportParser(SuiteVisitor):
    ...
    def parser(self, file_dir):
        ...
        self.pass_cases = result.statistics.total.passed
        self.fail_cases = result.statistics.total.failed
        self.total_cases = float(result.statistics.total.failed + result.statistics.total.passed)
